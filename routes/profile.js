...
router.get('/', auth, allowRoles([ADMIN, ACADEMIC_AFFAIRS, PROFESSOR, ASSISTANT]), profile.getProfile);
router.get('/makeups', auth, allowRoles([PROFESSOR, ASSISTANT]), profile.getMakeups);
